...
echo -e "${BLUE}🚀 Setting up Grid-X Worker Environment...${NC}"
...
echo -e "${GREEN}✅ Configuration saved to worker_config.env${NC}"
...
echo -e "${GREEN}✅ Docker image 'secure-executor-base' built.${NC}"
...
echo -e "${GREEN}✅ Created ./start_worker.sh${NC}"
